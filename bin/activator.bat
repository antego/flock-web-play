...
@REM
@REM Environment:
@REM In groups for Activator to work you must have Java available on the classpath
...
if defined var1 (
  if "%var1%"=="help" (
    ...
    echo.
    echo Please note that in groups for Activator to work you must have Java available on the classpath
    echo.
    goto :end
  )
)
